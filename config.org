...
[2026-01-28] Got a job and a new schedule.

#+begin_src elisp
  (use-package org-pomodoro
    :custom
    (org-pomodoro-keep-killed-pomodoro-time 't)
    (org-pomodoro-length 60) ;; SLA for solving ticket is 1h
    (org-pomodoro-short-break-length 15) ;; ⅓
    (org-pomodoro-long-break-length 60) ;; обед по ТК
    :ensure t)
#+end_src

#+RESULTS:
: #s(hash-table data (:use-package (27001 45024 540939 286000) :init (27001 45024 540936 700000) :config (27001 45024 540927 283000) :config-secs (0 0 2 483000) :init-secs (0 0 15 275000) :use-package-secs (0 0 114 17000)))
...
#+begin_src elisp
  (use-package flymake-yamllint :ensure t)
  (add-hook 'yaml-mode-hook 'flymake-yamllint-setup)
#+end_src

#+RESULTS:
| flymake-yamllint-setup | yaml-set-imenu-generic-expression |
...
#+RESULTS:
: #s(hash-table data (:use-package (26950 54624 556143 739000) :init (26950 54624 556133 658000) :config (26950 54624 556106 363000) :config-secs (0 0 6 725000) :init-secs (0 0 313 72000) :use-package-secs (0 0 921 406000)))
