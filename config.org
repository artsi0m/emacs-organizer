...
**** I use howm with org-mode with latest version of org-latex-preview
Inline latex previews for formulas in flashcards was initial reason to switch to emacs for me.
Installed recent version with better handling of latex by [[https://abode.karthinks.com/org-latex-preview/#org00b65d9][this]] guide.
See init.el 
